...
#from .models_HierGlow_GMVAE import HierGlow_GMVAE
from .utils import load, load_total, save, get_proper_device
...
def build_total(x_channels, cond_channels, hparams, is_training):
    ...
    graph = HierGlow_GMVAE(x_channels, cond_channels, hparams)
    ...
    if graph is not None:
        ...
        if pre_trained is not None:
            loaded_step = load_total(os.path.basename(pre_trained),
                        model=graph, optim=optim, criterion_dict=None,
