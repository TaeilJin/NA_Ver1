...
def build_Dlow(x_channels, cond_channels, hparams, is_training):
    ...
    graph = modelDlow(x_channels, cond_channels, hparams.Gumbel.num_classes, hparams)
    ...
    if graph is not None:
        ...
        if is_training:
            ...
            pre_trained = hparams.Infer.pre_trained_dlow
