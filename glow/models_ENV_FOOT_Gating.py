...
from glow.models_SAMP import FootContactNet, FootContactNet_Gating
import numpy as np

class FOOT_estimator_Gating(nn.Module):
    def __init__(self, x_channels, cond_channels, num_classes,hparams):
        ...
        self.foot_estimator = FootContactNet_Gating(rng = np.random.RandomState(23456))
