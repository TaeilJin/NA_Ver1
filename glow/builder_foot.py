...
from .utils import load_Cond, save, get_proper_device
...
def build_Foot(x_channels, cond_channels, hparams, is_training):
    ...
    if hparams.Train.footmodel == "gating":
    ...
    if graph is not None:
        ...
        if is_training:
            ...
            pre_trained = hparams.Infer.pre_trained_foot
