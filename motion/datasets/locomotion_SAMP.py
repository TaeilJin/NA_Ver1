import os
import numpy as np
from .motion_data_SAMP import TrainDataset_SAMP, TestDataset_SAMP, ValidDataset_SAMP
...
class LocomotionSAMP():
    ...
    def __init__(self, hparams, is_training):
        ...
        self.train_dataset = TrainDataset_SAMP(data_dir,hparams.Data.seqlen, hparams.Data.dropout)
        self.test_dataset = TestDataset_SAMP(data_dir,hparams.Data.seqlen, hparams.Data.dropout)
        self.validation_dataset = ValidDataset_SAMP(data_dir,hparams.Data.seqlen, hparams.Data.dropout)
                
        self.n_x_channels = self.joint
        self.env_dim = 2640
        self.n_descriptor_channels = self.n_x_channels*hparams.Data.seqlen + 3*(hparams.Data.seqlen + 1 + hparams.Data.n_lookahead)
        self.n_cond_channels = 3
