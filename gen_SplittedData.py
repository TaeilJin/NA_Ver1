...
def save_split_trainable_data(scaler, seqlen, data, filecnt_train, num_ee, num_vel, num_envsample, foot_contact =0, labelinfo=0, b_save=False, data_root=None):
    ...
    if(b_save):
        # trainable data 
        new_x, autoreg_control,single_control , autoreg_seq_control, autoreg_seq_single_control, new_ee,new_env,new_label, new_foot = create_Sequence_CondOnly_OutputData3(seqlen,scaled_data_X,num_ee,num_vel,num_envsample,labelinfo,
