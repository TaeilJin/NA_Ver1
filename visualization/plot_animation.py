...
def plot_animation_withRef_tarMat(clip, refclip, parents, filename=None, fps=30, axis_scale=50, elev=45, azim=45):
    ...
    joints = clip[:,:-3]
    root_pos = clip[...,-(9):-6]
    root_rot_forward = clip[...,-6:-3]
    root_rot_right = clip[...,-3:]
